...
const caisseCommunaute = [
  ...
  "On vous a invité à un after. Buvez 2Ǥ.",
  /*€*/"La police vous arrête pour ivresse publique. Avancez directement au Stand PLS. Ne passez pas par la case Départ.",
  "Diagnostic médical, votre foie est en bonne santé. Buvez 1Ǥ.",
  "Tournée générale ! Tous les joueurs boivent 1Ǥ.",
  "Vous êtes élu président du BDE. Distribuez 5Ǥ.",
  "Vous retrouvez un ami en soirée. Buvez 1Ǥ.",
  "Tu arrêtes la drogue (temporairement)! Pour fêter ça buvez 1Ǥ.",
  "On vous offre un verre en soirée. Buvez 5Ǥ.",
  ...
  /*€*/"Vous partez au meilleur Event Rezo ! Avancez jusqu'à la Violette (d'ailleurs venez à la Purple le 16 novembre !). Si elle appartient à un autre joueur vous buvez, sinon vous pouvez l'organiser.",
  "Vous vous pétez le frein dans une Peip1. Buvez 10Ǥ.",
  "On vous prank avec une bouteille de pisse. Pour oublier ça buvez 5Ǥ.",
  "On l'aime bien la p'tite Jaja, elle est si belle et si gentille... Buvez 2Ǥ.",
...
const chance = [
  ...
  /*€*/"C'est le début de l'Inté ! Déplacez vous sur la case de l'Inté. Si elle appartient à un autre joueur vous buvez, sinon vous pouvez l'organiser.",
  /*€*/"C'est la fin de l'Inté, vous partez au WEA. Déplacez vous sur la case du WEA. Si elle appartient à un autre joueur vous buvez, sinon vous pouvez l'organiser.",
  "Vous tenez votre verre de la main droite. BUFFALO ! Buvez 10Ǥ.",
  "Il a très bien chanté, buvons à sa santé... Buvez 1Ǥ.",
  "Un Make u Move est lancé. Tous les joueurs boivent 5Ǥ.",
  "C'est l'heure des comptes. Buvez un nombre de Ǥ (gorgées) équivalent à votre nombre d'Events.",
  "Un mètre de shots a été commandé, vous participez. Buvez 1Ǥ.",
  "Le Staff ramène un nouveau bidon de Jaja. Buvez 2Ǥ.",
  ...
  "Choisissez un joueur, chacun lance un dé. Le perdant bois 3Ǥ.",
  ...
  "On vous fait un Polybrouillard. Pour la peine, buvez un verre d'eau.",
  "C'était le temps des fleurs où j'enculais ta s***r ... Censure de la FEDERP. Buvez 2Ǥ.",
  // Ajoutez d'autres cartes ici
];
